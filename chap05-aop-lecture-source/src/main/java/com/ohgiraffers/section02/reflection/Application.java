...
public class Application {
    public static void main(String[] args) {
         ...
         *   spring framework, myBatis, hybernate, jackson 등의 라이브러리에서 사용된다.
         *   spring 에서는 런타임 시 개발자가 등록한 빈을 애플리케이션 내에서 사용할 수 있게 하는 기술이기도 하다.
         *  .
         *  reflection 은 강력한 도구이지만 무분별하게 사용해서는 안된다.
         *  1. 오버헤드 발생: 성능 저하가 발생할 수 있기 때문에 민감한 애플리케이션에서는 사용하지 않는다
         *  2. 캡슐화 저해: private 로 설정한 member(또는 필드)에 접근 가능하기 때문에 코드 기능이 저하되며 여러가지 문재를 야기할 수 있다.
        * */

        /* 설명. 1. Class 타입의 Class 메타정보 추출 */
        System.out.println("\n================ 1. Class 타입의 Class 메타정보 추출 ================");
        ...
        try {
            // reflection 의 invoke 와 AOP 의 proceed 는 비슷한 역할
            // AOP 는 reflection 기술로 만들어진다.
